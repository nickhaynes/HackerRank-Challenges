...
# cake will have 4 candles of height 3, 2, 1, 3, she will be 
# able to blow out 2 candles successfully, since the tallest 
# candle is of height 3 and there are 2 such candles.
# 
# Complete the function birthdayCakeCandles that takes your 
# niece's age and an integer array containing height of each 
...
# each integer i describes the height of candle i.
# 
# Constraints
#
# 1 <= n <= 10^5
...
#
# Output Format
# Print the number of candles that can be blown out on a new 
# line.
# 
# Sample Input 0
# 
