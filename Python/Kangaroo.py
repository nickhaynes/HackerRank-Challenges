# You are choreograhing a circus show with various animals. For one act, you 
...
# per jump.
# 
# You have to figure out a way to get both kangaroos at the same location as 
# part of the show.
# 
# Complete the function kangaroo which takes starting location and speed of 
# both kangaroos as input, and return  or appropriately. Can you determine 
# if the kangaroos will ever land at the same location at the same time? The 
# two kangaroos must land at the same location after making the same number 
# of jumps.
# 
# Input Format
# 
...
# right) of the first kangaroo's starting location (i.e., ). Because the 
# second kangaroo moves at a faster rate (meaning ) and is already ahead of 
# the first kangaroo, the first kangaroo will never be able to catch up. 
# Thus, we print NO.
# 
# 
